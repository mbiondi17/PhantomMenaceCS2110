...
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class PlayGameEasy extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_play_game_easy);
		...
		bkgmus = MediaPlayer.create(PlayGameEasy.this, R.raw.bkgmustocatta);     //Tells the program where to find the music.
		...
		proximity = MediaPlayer.create(PlayGameEasy.this, R.raw.enemyalert);
		proximity.setLooping(false);
		coinsound = MediaPlayer.create(PlayGameEasy.this, R.raw.coinsoundeffect);
	...
	public void clickUp(View v) {
		...
		for(int i = 0; i < ghostList.size(); i++) {
			...
			if(checkKilled(character, ghostList.get(i))) {
				Intent intent1 = new Intent(this, DeathScreenEasy.class);
