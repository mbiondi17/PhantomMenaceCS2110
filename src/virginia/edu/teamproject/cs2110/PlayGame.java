...
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class PlayGame extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bkgmus = MediaPlayer.create(PlayGame.this, R.raw.bkgmustocatta);     //Tells the program where to find the music.
		...
		proximity = MediaPlayer.create(PlayGame.this, R.raw.enemyalert);
		proximity.setLooping(false);
		coinsound = MediaPlayer.create(PlayGame.this, R.raw.coinsoundeffect);
	...
	public void clickUp(View v) {
		...
		for(int i = 0; i < ghostList.size(); i++) {
			...
			if(checkKilled(character, ghostList.get(i))) {
				Intent intent1 = new Intent(this, DeathScreen.class);
